...
public class Product {
    ...
    public ResultSet readByID() {
        ...
        {
            Connection con = kon.openConnection();
            String sql = "select * from tb_barang where idprod = ?";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, this.IDProd);
    ...
    public int update() {
        ...
        {
            Connection con = kon.openConnection();
            String sql = "update tb_barang set nama=?, stok=?, price=? where idprod=?";
            PreparedStatement ps = con.prepareStatement(sql);
    ...
    public int destroy() {
        ...
        {
            Connection con = kon.openConnection();
            String sql = "delete from tb_barang where idprod = ?";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, this.IDProd);
            int res = ps.executeUpdate();
            return res;
